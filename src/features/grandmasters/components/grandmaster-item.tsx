  ...
  return (
    <div className='shadow-medium hover:shadow-strong border-accent-100 transform rounded-xl border bg-white p-6 transition-all duration-300 hover:-translate-y-1'>
      ...
      <div className='mb-4 flex justify-center'>
        <div className='relative'>
          <Image
            ...
            width={80}
            height={80}
            className='border-accent-100 group-hover:border-secondary-200 [&>svg]:stroke-accent-100 aspect-square rounded-full border-4 object-cover transition-colors'
          />
        </div>
      </div>
      ...
      <div className='text-center'>
        <h3 className='text-accent-800 group-hover:text-primary-600 mb-1 truncate text-lg font-bold transition-colors'>
          {grandmaster.name || '\u00A0'}
        </h3>
